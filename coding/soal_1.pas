...
// Fungsi untuk mengecek apakah produk tertentu memiliki diskon pada hari yang dimasukkan
...
begin
    if (hari = 'senin') and (kategori = '1') then
        ...
        kategori_diskon := 0.0; // Tidak ada diskon pada hari lain
end;
...
begin
    ...
    readln(nama_anggota);
    writeln;
    write('Hari : ');readln(hari); // Meminta input hari sebagai string
    writeln;
